...
path = '/mnt/datosnas/Users/cmejia/EMOTION-DETECTION/AFFECTNET-STABLE-DIFFUSION/TRAIN/'
...
checkpoint = ModelCheckpoint("best_model_affectnet.h5", monitor='val_accuracy', save_best_only=True, save_weights_only=False, mode='max', verbose=1)
...
best_model = models.load_model('best_model_affectnet.h5')
