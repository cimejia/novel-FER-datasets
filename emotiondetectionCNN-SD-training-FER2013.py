...
path = '/mnt/datosnas/Users/cmejia/EMOTION-DETECTION/FER2013-STABLE-DIFFUSION/TRAIN/'
...
checkpoint = ModelCheckpoint("best_model_fer2013.h5", monitor='val_accuracy', save_best_only=True, save_weights_only=False, mode='max', verbose=1)
...
plt.xlabel('epoch')
plt.savefig("LearningCurves-sinnorm.eps")
#plt.show()
...
best_model = models.load_model('best_model_fer2013.h5')
